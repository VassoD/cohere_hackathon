...
def search_articles(search_query):
    ...
    subreddit_mapping = {"technews": "Tech News", "UkraineWarVideoReport": "Ukraine War Report", "worldnews": "World News",
                         "ClimateNews": "Climate News", "Coronavirus": "Covid 19 News", "business": "Business News", "Health": "Health News"}
    matching_articles = []
    prediction = co.classify(model='large', inputs=[
                             search_query], examples=examples).classifications[0].prediction
    ...
    business_keywords = ['business', 'economy', 'finance', 'banks', 'banks', 'investment', 'market', 'stock', 'startup',
                         'entrepreneurship', 'mergers', 'acquisitions', 'corporation', 'industry', 'commercial', 'trade', 'money', 'euro']
    health_keywords = ['health', 'medicine', 'disease', 'medical', 'hospital', 'doctor', 'virus', 'vaccine', 'cure',
                       'illness', 'symptoms', 'diseases', 'medical treatment', 'medical research', 'healthcare', 'pharmaceutical', 'drugs']
    ukraine_keywords = ['ukraine', 'russia', 'war',
                        'politics', 'government', 'ukrainian', 'kiev', 'crimea']
    worldnews_keywords = ['world', 'worldnews', 'countries',
                          'international', 'global', 'events', 'affairs', 'foreign', 'headlines']
    climateNews_keywords = ['climate', 'climate change',
                            'global warming', 'environment', 'environmental']
    covid_keywords = ['covid', 'covid19', 'coronavirus',
                      'pandemic', 'virus', 'vaccine', 'corona']
